...
export default function AboutPage() {
  ...
  useEffect(() => {
    document.title = "Giới thiệu | VAA Hotel";
  }, []);
  ...
  return (
    <div className="relative min-h-screen bg-[url('https://images.unsplash.com/photo-1551882547-ff40c63fe5fa?auto=format&fit=crop&w=1600&q=80')] bg-cover bg-center text-white">
      ...
      <section className="relative z-10 pt-32 pb-20 text-center px-6">
        <h1
          className="text-5xl font-[Playfair_Display] text-cyan-400 font-bold mb-4 drop-shadow-[0_2px_10px_rgba(34,211,238,0.6)]"
          data-aos="fade-down"
        >
          Về Chúng Tôi
        </h1>
        <p
          ...
          data-aos="fade-up"
        >
          <strong>VAA Hotel</strong> – biểu tượng của sự sang trọng và tinh tế
      ...
      <section className="relative z-10 container mx-auto px-6 py-12 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        ...
        <div data-aos="fade-left">
          <h2 className="text-3xl font-[Playfair_Display] text-cyan-400 mb-4">Không gian sang trọng</h2>
          <p className="text-gray-300 text-base leading-relaxed">
            Tọa lạc giữa trung tâm quận 1 sầm uất, VAA Hotel là nơi giao thoa giữa hiện đại và truyền thống.
      ...
      <section className="relative z-10 bg-black/40 backdrop-blur-md py-20">
        <div className="container mx-auto px-6 text-center">
          <h2
            className="text-4xl font-[Playfair_Display] text-cyan-400 mb-8"
            data-aos="fade-down"
          >
            Tầm nhìn & Sứ mệnh
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 text-gray-300">
            <div
              className="bg-white/5 p-6 rounded-xl border border-cyan-400/20 shadow-[0_0_20px_rgba(34,211,238,0.15)]"
              data-aos="fade-right"
            >
              <h3 className="text-cyan-400 text-xl mb-3">Tầm nhìn</h3>
              <p>
            ...
            <div
              ...
              data-aos="fade-left"
            >
              <h3 className="text-cyan-400 text-xl mb-3">Sứ mệnh</h3>
              <p>
      ...
      <section className="relative z-10 container mx-auto px-6 py-20 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        <div data-aos="fade-right">
          <h2 className="text-3xl font-[Playfair_Display] text-cyan-400 mb-4">
            Đội ngũ chuyên nghiệp
          </h2>
          <p className="text-gray-300 text-base leading-relaxed">
            Mỗi thành viên trong đội ngũ của VAA Hotel đều được đào tạo bài bản,
      ...
      {/* CTA */}
      <section className="relative z-10 bg-gradient-to-r from-cyan-500/10 to-cyan-500/10 backdrop-blur-md text-center py-20 border-t border-cyan-400/30">
        <h2
          className="text-3xl md:text-4xl font-[Playfair_Display] text-cyan-400 mb-6"
          data-aos="fade-up"
        >
          Trải nghiệm sự đẳng cấp tại VAA Hotel
        </h2>
        <button
